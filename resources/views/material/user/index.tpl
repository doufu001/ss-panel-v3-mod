											...
											<div class="tab-content">
												...
												<div class="tab-pane fade {if !$ssr_prefer}active in{/if}" id="all_ss">
													...
													<div class="tab-pane fade" id="all_ss_windows">
														...
														2.点击下载<a href="https://sub.mpdf.us/sub?target=clash&filename=config.yaml&config=https://dl.mpdf.us/sub.ini&url={$baseUrl}/link/{$ios_token}?is_ss=1">配置文件</a><br>
														...
														2.右键复制<a href="https://sub.mpdf.us/sub?target=clash&config=https://dl.mpdf.us/sub.ini&url={$baseUrl}/link/{$ios_token}?is_ss=1">这个链接</a><br>
													...
													<div class="tab-pane fade" id="all_ss_ios">
														...
														2.长按<a href="https://sub.mpdf.us/sub?target=clash&config=https://dl.mpdf.us/sub.ini&url={$baseUrl}/link/{$ios_token}?is_ss=1">这个链接</a>（不是点击，是长按！），点击“拷贝”<br>
														...
														2.长按<a href="https://sub.mpdf.us/sub?target=quanx&list=true&url={$baseUrl}/link/{$ios_token}?is_ss=1">这个链接</a>（不是点击，是长按！），点击“拷贝”<br>
													...
													<div class="tab-pane fade" id="all_ss_android">
														...
														2.在手机浏览器中长按<a href="https://sub.mpdf.us/sub?target=clash&config=https://dl.mpdf.us/sub.ini&url={$baseUrl}/link/{$ios_token}?is_ss=1">这个链接</a>，选择“复制链接网址”<br>
													...
													<div class="tab-pane fade" id="all_ss_router">
														...
														5.找到“Clash-Yaml配置下载”，右键复制<a href="https://sub.mpdf.us/sub?target=clash&config=https://dl.mpdf.us/sub.ini&url={$baseUrl}/link/{$ios_token}?is_ss=1">这个链接</a>，粘贴到右侧的文本框中<br>
